    ...
    <div class="row">
                    ...
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="collapse" id="colors_container">
                            ...
                            <div class="form-group" data-range-counter data-range-counter-suffix="%">
                                ...
                                <input id="background_color_transparency" type="range" min="0" max="100" step="10" name="background_color_transparency" value="<?= $data->qr_code->settings->background_color_transparency ?? 0 ?>" class="form-control <?= \Altum\Alerts::has_field_errors('background_color_transparency') ? 'is-invalid' : null ?>" data-reload-qr-code />
                        ...
                        <div class="collapse" id="branding_container">
                            <div class="form-group">
                                ...
                                <?php if(!empty($data->qr_code->qr_code_logo)): ?>
                                    <input type="hidden" name="qr_code_logo" value="<?= \Altum\Uploads::get_full_url('qr_codes') . $data->qr_code->qr_code_logo ?>" />
                                    <div class="m-1">
                                        <img src="<?= \Altum\Uploads::get_full_url('qr_codes') . $data->qr_code->qr_code_logo ?>" class="img-fluid" style="max-height: 2.5rem;height: 2.5rem;" />
                                    </div>
        ...
        <div class="col-12 col-xl-6">
            <div class="sticky">
                ...
                <button id="embedded_data_container_button" class="btn btn-block btn-light my-4" type="button" data-toggle="collapse" data-target="#embedded_data_container" aria-expanded="false" aria-controls="embedded_data_container">
