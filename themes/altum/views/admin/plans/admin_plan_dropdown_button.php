...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <?php if(is_numeric($data->id)): ?>
            ...
            <a href="#" data-toggle="modal" data-target="#plan_delete_modal" data-plan-id="<?= $data->id ?>" data-resource-name="<?= $data->resource_name ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-trash-alt mr-2"></i> <?= l('global.delete') ?></a>
        <?php endif ?>
    </div>
</div>
