        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <div class="row btn-group-toggle" data-toggle="buttons">
                    <div class="col-6">
                        <label class="btn btn-light btn-block <?= $data->values['type'] == 'internal' ? 'active"' : null?>">
                    ...
                    <div class="col-6">
                        <label class="btn btn-light btn-block <?= $data->values['type'] == 'external' ? 'active"' : null?>">
            ...
            <div class="form-group">
                ...
                <div class="row btn-group-toggle" data-toggle="buttons">
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->values['position'] == 'bottom' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->values['position'] == 'top' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->values['position'] == 'hidden' ? 'active"' : null?>">
