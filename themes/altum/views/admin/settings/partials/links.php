...
<div>
    ...
    <div class="form-group custom-control custom-switch">
        <input id="qr_code_reader_is_enabled" name="qr_code_reader_is_enabled" type="checkbox" class="custom-control-input" <?= settings()->links->qr_code_reader_is_enabled ? 'checked="checked"' : null?>>
        <label class="custom-control-label" for="qr_code_reader_is_enabled"><?= l('admin_settings.links.qr_code_reader_is_enabled') ?></label>
    </div>
