        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <div class="row btn-group-toggle" data-toggle="buttons">
                    <div class="col-6">
                        <label class="btn btn-light btn-block <?= $data->page->type == 'internal' ? 'active"' : null?>">
                    ...
                    <div class="col-6">
                        <label class="btn btn-light btn-block <?= $data->page->type == 'external' ? 'active"' : null?>">
            ...
            <div class="form-group" data-type="internal">
                ...
                <div class="row btn-group-toggle" data-toggle="buttons">
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->page->editor == 'wysiwyg' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->page->editor == 'blocks' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->page->editor == 'raw' ? 'active"' : null?>">
            ...
            <div class="form-group">
                ...
                <div class="row btn-group-toggle" data-toggle="buttons">
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->page->position == 'bottom' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->page->position == 'top' ? 'active"' : null?>">
                    ...
                    <div class="col-12 col-lg-4">
                        <label class="btn btn-light btn-block <?= $data->page->position == 'hidden' ? 'active"' : null?>">
