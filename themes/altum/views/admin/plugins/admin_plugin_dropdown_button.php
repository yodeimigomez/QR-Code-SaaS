...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <?php if($data->status === -1 || $data->status == 'uninstalled'): ?>
            <a href="<?= url('admin/plugins/install/' . $data->id . '&global_token=' . \Altum\Csrf::get('global_token')) ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-server mr-2"></i> <?= l('admin_plugins.install') ?></a>
